class Rope
  {
    ...
    //nlink= nº de links, pointA= pontos de conexão
    {
      this.nlink = nlink
  const group = Body.nextGroup(true);
  // composite é para criar varios corpos de rect
  ...
  World.add(engine.world, this.body);
    ...
    //Constraint.create -> restrição ao grupo que conecta todos os corpos 
